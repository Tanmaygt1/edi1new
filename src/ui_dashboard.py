...
class DrowsinessUI(QWidget):
    def __init__(self):
        ...
        for b in [self.start_btn, self.stop_btn, self.export_btn]:
            b.setStyleSheet(
                "padding:10px;font-size:14px;background:#1f1f1f;border:1px solid #555;"
            )
    ...
    def start(self):
        ...
        self.timer.start(50)  # SAFE FPS
        self.info.setText("Status: Running")

    def stop(self):
        self.timer.stop()
        if self.cap:
            self.cap.release()
        self.info.setText("Status: Stopped")
    ...
    def export_session(self):
        ...
        self.info.setText(f"Exported: {fname}")
    ...
    def update_frame(self):
        ...
        # Microsleep (ALARM DURING CLOSURE)
